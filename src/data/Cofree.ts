...
export const extract = <F extends TypeLambda, R, O, E, A>(wa: Cofree<F, R, O, E, A>): A => {
  return wa[0]
}
...
export const extend = <F extends TypeLambda>(
  ...
  return function extend<R, O, E, A, B>(
    self: Cofree<F, R, O, E, A>,
    f: (wa: Cofree<F, R, O, E, A>) => B
  ): Cofree<F, R, O, E, B> {
...
export const distHisto = <F extends TypeLambda>(
  F: Covariant<F>
): (<R, O, E, A>(self: Kind<F, R, O, E, Cofree<F, R, O, E, A>>) => Cofree<F, R, O, E, Kind<F, R, O, E, A>>) => {
  F
  return function distHisto<R, O, E, A>(
    self: Kind<F, R, O, E, Cofree<F, R, O, E, A>>
  ): Cofree<F, R, O, E, Kind<F, R, O, E, A>> {
