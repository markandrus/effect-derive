...
import { Cofree, extract } from './Cofree'
...
export const cata = <T extends TypeLambda, F extends TypeLambda, TR, TO, TE, TA, FR, FO, FE>(
...
export const para = <T extends TypeLambda, F extends TypeLambda, TR, TO, TE, TA, FR, FO, FE>(
  T: Recursive<T, F, TR, TO, TE, TA, FR, FO, FE>
...
export const histo = <T extends TypeLambda, F extends TypeLambda, TR, TO, TE, TA, FR, FO, FE>(
  T: Recursive<T, F, TR, TO, TE, TA, FR, FO, FE>
) => <A>(g: CofreeAlgebra<F, FR, FO, FE, FR, FO, FE, A>) => (ta: Kind<T, TR, TO, TE, TA>): A => {
